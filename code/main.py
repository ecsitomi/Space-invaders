...
class Game:
	def __init__(self):
		...
		self.create_multiple_obstacles(*self.obstacle_x_positions, x_start = WIDTH / 15, y_start = HEIGHT - 300)
...
if __name__ == '__main__':
	...
	pygame.time.set_timer(ALIENLASER,alientimer) #IDE KELL AZ IDŐZÍTŐ
